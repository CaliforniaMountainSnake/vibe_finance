...
- В самом конце в стиле `Conventional Commits` придумать название для ветки и составить короткий текстовый комментарий для коммита с описанием того, что было сделано.
