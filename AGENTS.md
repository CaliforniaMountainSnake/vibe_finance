...
- В самом конце в стиле `Conventional Commits` придумать название для ветки (проверь, что такой еще нет) и составить текстовый комментарий для коммита на русском языке с описанием того, что было сделано.
