...
- В проекте строгий ESLint с ограничениями на когнитивную сложность, размеры функций и файлов, именование и стиль.
...
- Если нужно быстро параллельно проверить сразу тесты, сборку, линтер, форматирование: `npm run check-all`.
