...
import { ticker, pair, sameSourcePair } from './database-repository-test-helpers'

export function assertDatabaseRepositoryFavorites(makeRepo: () => DatabaseRepositoryInterface) {
